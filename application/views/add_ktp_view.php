      ...
      <div class="wrapper">
        ...
        <table class="tableForm">
			...
			<tr>
				...
				<td><input type="date" id="date" name="tanggal_lahir" value="<?php echo $this->input->post('tanggal_lahir'); ?>" max=<?php echo date('Y-m-d'); ?> required /></td>
			</tr>
			<tr>
				<td>Rt : </td>
				<td><input type="text" name="rt" value="<?php echo $this->input->post('rt'); ?>" maxlength="3" /></td>
			</tr>
			<tr>
				<td>Rw : </td>
				<td><input type="text" name="rw" value="<?php echo $this->input->post('rw'); ?>" maxlength="3" /></td>
			</tr>
			<tr>
				<td>Kelurahan : </td>
			...
			<tr>
				...
				<!-- <td><input type="text" name="" value="<?php echo $this->input->post('kewarganegaraan'); ?>" required /></td> -->
				<td>
					...
					foreach($jenis_kelamin_values as $value => $display_text)
					{
						$selected = ($value == $this->input->post('kewarganegaraan')) ? ' selected="selected"' : "";
