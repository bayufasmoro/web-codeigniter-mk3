    ...
    <div class="home_content">
      ...
      <div class="home_div_table">
        ...
        <?php echo form_open('ktp/add'); ?>
			...
			<div>
				Tanggal Lahir : 
				<input type="date" name="tanggal_lahir" value="<?php echo $this->input->post('tanggal_lahir'); ?>" />
			</div>
			<div>
				Rt : 
			...
			<div>
				Status Perkawinan : 
				<input type="text" name="status_perkawinan" value="<?php echo $this->input->post('status_perkawinan'); ?>" />
			</div>
			<div>
				Pekerjaan : 
			...
			<div>
				Kewarganegaraan : 
				<input type="text" name="kewarganegaraan" value="<?php echo $this->input->post('kewarganegaraan'); ?>" />
			</div>
			<div>
				Berlaku Hingga : 
				<input type="date" name="berlaku_hingga" value="<?php echo $this->input->post('berlaku_hingga'); ?>" />
			</div>
			<div>
				Alamat : 
				<textarea name="alamat"><?php echo $this->input->post('alamat'); ?></textarea>
			</div>
